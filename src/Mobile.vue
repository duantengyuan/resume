...
/* 代码高亮 */
.token.selector{ 
  color: rgb(164,220,63); 
  }
.token.property{ 
  color: rgb(107,217,238); 
  }
.token.punctuation{ 
...
前端开发工程师
现在在 [集思学院](https://www.pathacademics.com/) 任职前端开发工程师。
...
> 如果你喜欢这个效果，
Fork [我的项目](https://github.com/duantengyuan/resume)，打造你自己的简历！
